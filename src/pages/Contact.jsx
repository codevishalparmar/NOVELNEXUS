...
function Contact() {
  const {
    ...
    handleSubmit,
    reset,
    //watch, for live previews or conditional UI changes.
    formState: { errors },
  } = useForm();

  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "e30324ed-e381-44fb-be11-b1e6b998b699",
      name: data.username,
      email: data.email,
            ...
            <div className="w-full md:w-1/2 md:pl-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-2">
                  ...
                  <span>+91 9770105571</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaEnvelope className="text-pink-500" />
                  <span>vishalparmar633@gmail.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaMapMarkerAlt className="text-green-500" />
                  <span>Dhar, Madhya Pradesh</span>
                </li>
              </ul>
            </div>
          </div>
